...
--
-- Table structure for table `judgement_people`
--

DROP TABLE IF EXISTS `judgement_people`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `judgement_people` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `judgement_id` int(11) unsigned NOT NULL,
  `people_id` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `judgement_people_judgement_id` (`judgement_id`),
  KEY `judgement_people_people_id` (`people_id`),
  CONSTRAINT `judgement_people_judgement_id` FOREIGN KEY (`judgement_id`) REFERENCES `judgement` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `judgement_people_people_id` FOREIGN KEY (`people_id`) REFERENCES `people` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
